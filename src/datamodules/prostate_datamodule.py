...
from src.datamodules.ubc_datamodule import make_dataset
from src.datamodules.harvard_datamodule import HarvardDataset, prepare_prostate_harvard_data
...
class ProstateDataModule(ColonDataModule):
    ...
    def setup(self, stage=None):
        ...
        if stage == "fit" or stage is None:
            ...
            train_set2, valid_set2 = make_dataset(stage="train")
            ...
            self.valid_dataset = ProstateDataset(valid_set1+valid_set2, self.test_transform)

        else:
            test_set1 = prepare_prostate_harvard_data(stage="test")
            test_set2 = make_dataset(stage="test")

            self.test_dataset = ProstateDataset(test_set1+test_set2, self.test_transform)